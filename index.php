...
<section class="aboutUs" id="aboutUs">
        <div class="container ">
            <div class="row my-5" style="justify-content: between;">
                <div class="col-lg-6 col-sm-12"><img src="images/aboutimg2.jpg" width="80%"></div>
  ...
  <div class="container text-center">
    <div class="row" style="justify-content: space-between;">
      ...
      <div class="cm col-lg-4 col-sm-12 my-5 ">
        <img src="images/multyCourse.jpg" class="card-img-top" style="border-radius:4px;">
      ...
      <div class="cm col-lg-4 col-sm-12 my-5">
        ...
        <img src="images/courseSoft.jpg" class="card-img-top" style="border-radius:4px;">
        <div class=" text-center">
      ...
      <div class="cm col-lg-4 col-sm-12 my-5">
        <img src="images/architect.jpg" class="card-img-top" style="border-radius:4px;">
        <div class=" text-center">
      ...
      <div class="cm col-lg-4 col-sm-12 my-5">
        ...
        <img src="images/electric.jpg" class="card-img-top" style="border-radius:4px;">
        <div class=" text-center">
...
<img src="images/camp.jpg" class="card-img-top" style="border-radius:4px;">
<div class=" text-center">
  <a href="courseMultyMedia.php" class="btn btn-primary btn-lg btn-block " style="width: 100%;background-color:#4F7AC8;"> مخيمات و مسابقات </a>
      ...
      <div class="cm col-lg-4 col-sm-12 my-5">
        ...
        <img src="images/warshat.jpg" class="card-img-top" style="border-radius:4px;">
        <div class=" text-center">
